...
@section('title', 'Admin | Edit Beauty')
...
<div class="row">
     <div class="col-md-12">
          <div class="card shadow">
               ...
               <div class="card-body">
                    <form action="{{ route('beauty.update', encrypt($b->id)) }}" method="POST" enctype="multipart/form-data">
                         @csrf
                         @method('put')
                         <div class="row mb-3">
                              <div class="col-md-6">
                         ...
                         <div class="row mb-3">
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="kode_beauty" value="{{ $b->kode_beauty }}" id="kode_beauty" class="form-control @error('kode_beauty') is-invalid @enderror" placeholder="masukkan kode beauty">
                                   @error('kode_beauty')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="nama_beauty" value="{{ $b->nama_beauty }}" id="nama_beauty" class="form-control @error('nama_beauty') is-invalid @enderror" placeholder="masukkan nama beauty">
                                   @error('nama_beauty')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
                         ...
                         <div class="row mb-3">
                              <div class="col-md-6">
                                   ...
                                   <input type="number" name="stok_beauty" value="{{ $b->stok_beauty }}" id="stok_beauty" class="form-control @error('stok_beauty') is-invalid @enderror" placeholder="masukkan stok beauty">
                                   @error('stok_beauty')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
                              <div class="col-md-6">
                                   ...
                                   <input type="number" name="harga_beauty" value="{{ $b->harga_beauty }}" id="harga_beauty" class="form-control @error('harga_beauty') is-invalid @enderror" placeholder="masukkan harga beauty">
                                   @error('harga_beauty')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
