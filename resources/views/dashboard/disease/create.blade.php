...
@section('title', 'Admin | Tambah Penyakit')
                    ...
                    <form action="{{ route('disease.store') }}" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="row mb-3">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="nama_penyakit" id="nama_penyakit" class="form-control @error('nama_penyakit') is-invalid @enderror" placeholder="masukkan nama penyakit">
                                   @error('nama_penyakit')
                                       <div class="alert alert-danger mt-2 mb-2 p-">{{ $message }}</div>
                                   @enderror
                              </div>
                         ...
                         <div class="row mb-3">
                              <div class="col-md-12">
                                   ...
                                   <textarea name="deskripsi_penyakit" id="deskripsi_penyakit" cols="30" rows="5" class="form-control @error('deskripsi_penyakit') is-invalid @enderror" placeholder="masukkan deskripsi penyakit"></textarea>
